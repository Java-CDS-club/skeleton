...
public class IntList {
     ...
     */
    public static IntList addLast(IntList C, int x){
        if (C==null) {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList track1=A;
        IntList track2=B;
        while (track1.tail!=null){
            track1=track1.tail;
            addLast(newList, track1.head);
        }
        addLast(newList, B.head);
        while (track2.tail!=null){
            track2=track2.tail;
            addLast(newList, track2.head);
        }
        return newList;
    }
